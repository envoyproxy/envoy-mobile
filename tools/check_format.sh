...
ENVOY_BAZEL_PREFIX=@envoy envoy/tools/code_format/check_format.py \
    --add-excluded-prefixes ./envoy/ ./BUILD ./envoy_build_config/extensions_build_config.bzl ./WORKSPACE ./dist/Envoy.framework/ ./library/common/config_template.cc ./bazel/envoy_mobile_swift_bazel_support.bzl ./bazel/envoy_mobile_repositories.bzl \
