...
CC=clang TEST_TMPDIR=${BUILD_DIR:-/tmp}/envoy-mobile-compdb envoy/tools/gen_compilation_database.py --vscode --include_external --include_genfiles --include_headers --bazel ./bazelw //library/cc/... //library/common/... //test/cc/... //test/common/...
