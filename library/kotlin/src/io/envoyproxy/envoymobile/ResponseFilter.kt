...
interface ResponseFilter: Filter {
   ...
   */
  fun onResponseHeaders(headers: ResponseHeaders, endStream: Bool): FilterHeaderStatus<ResponseTrailers>
   ...
   */
  fun onResponseData(body: ByteBuffer, endStream: Bool): FilterDataStatus
