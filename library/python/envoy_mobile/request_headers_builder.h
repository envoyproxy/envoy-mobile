...
public:
  RequestHeadersBuilder(RequestMethod::_RequestMethod request_method,
  ...
  RequestHeadersBuilder& add_upstream_http_protocol(UpstreamHttpProtocol::_UpstreamHttpProtocol upstream_http_protocol);
