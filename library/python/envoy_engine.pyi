...
class StreamPrototype:
    ...
    def set_on_headers(self, on_headers: Callable[["ResponseHeaders", bool, "StreamIntel"], None]) -> "StreamPrototype": ...
    def set_on_data(self, on_data: Callable[[bytes, bool, "StreamIntel"], None]) -> "StreamPrototype": ...
    def set_on_trailers(self, on_trailers: Callable[["ResponseTrailers", "StreamIntel"], None]) -> "StreamPrototype": ...
    def set_on_error(self, on_trailers: Callable[["EnvoyError", "StreamIntel", "FinalStreamIntel"], None]) -> "StreamPrototype": ...
    def set_on_complete(self, on_complete: Callable[["StreamIntel", "FinalStreamIntel"], None]) -> "StreamPrototype": ...
    def set_on_cancel(self, on_cancel: Callable[["StreamIntel", "FinalStreamIntel"], None]) -> "StreamPrototype": ...
