...
public class StreamPrototype: NSObject {
  ...
  private var flowControlled = false
  ...
  ///
  /// - parameter flowControlled: Whether client flow control will be enabled for the stream.
  /// - returns:  This stream, for chaining syntax.
  public func enableFlowControl(flowControlled: Boolean) -> StreamPrototype {
