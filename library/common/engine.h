...
public:
   ...
   * @param logging_callbacks, the callbacks to use for engine logging.
   ...
   */
  Engine(envoy_engine_callbacks callbacks, envoy_logging_callbacks logging_callbacks,
...
private:
  ...
  envoy_logging_callbacks logging_callbacks_;
