...
// A platform file based key value store, which loads from and flushes based on
...
public:
  PlatformKeyValueStore(Event::Dispatcher& dispatcher, std::chrono::milliseconds flush_interval,
