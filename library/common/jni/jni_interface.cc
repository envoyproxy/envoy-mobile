...
extern "C" JNIEXPORT jstring JNICALL
Java_io_envoyproxy_envoymobile_engine_JniLibrary_androidDNSResolverTemplateString(JNIEnv* env,
                                                                                  jclass // class
) {
  jstring result = env->NewStringUTF(android_dns_resolver_template);
  return result;
}
