...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoymobile_envoyengine_EnvoyEngine_run(JNIEnv* env,
                                                                                 jobject, // this
                                                                                 jstring config) {
...
Java_io_envoyproxy_envoymobile_envoyengine_EnvoyEngine_initialize(JNIEnv* env,
                                                      jclass, // class
...
extern "C" JNIEXPORT jboolean JNICALL Java_io_envoyproxy_envoymobile_envoyengine_EnvoyEngine_isAresInitialized(
    JNIEnv* env,
    jclass // class
) {
