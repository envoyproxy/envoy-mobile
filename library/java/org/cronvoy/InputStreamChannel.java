...
/**
 * Adapts an {@link InputStream} into a {@link ReadableByteChannel}, exactly like {@link
 * java.nio.channels.Channels#newChannel(InputStream)} does, but more efficiently, since it does not
 * allocate a temporary buffer if it doesn't have to, and it freely takes advantage of {@link
 * FileInputStream}'s trivial conversion to {@link java.nio.channels.FileChannel}.
 */
