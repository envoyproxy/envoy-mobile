...
public enum EnvoyNativeResourceRegistry {
  ...
  private Collection refMaintainer; // Maintains references in the object graph while we wait for them to be enqueued.
  ...
  public static void register(EnvoyNativeResourceWrapper owner, long nativeHandle, EnvoyNativeResourceReleaser releaser) {
