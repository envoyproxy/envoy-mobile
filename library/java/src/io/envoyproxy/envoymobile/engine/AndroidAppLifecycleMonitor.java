...
class AndroidAppLifecycleMonitor implements ActivityLifecycleCallbacks {
  @Override
...
// //
// ///**
// // * This class makes use of some deprecated APIs, but it's only current purpose
// // * is to attempt to distill some notion of a preferred network from the OS, upon
// // * which we can assume new sockets will be opened.
// // */
// //@TargetApi(Build.VERSION_CODES.LOLLIPOP)
// // public class AndroidDeviceLifecycleMonitor extends Activity {
...
// //    context.getSystemService(Context.CONNECTIVITY_SERVICE); networkRequest = new
