...
- Adds pluggable logging capabilities
- Adds stats API
- Adds platform Filters
- Adds access arbitrary strings
...
- Adds end-to-end testing that covers roundtrip code execution from the platform layer to the
  core layer.
