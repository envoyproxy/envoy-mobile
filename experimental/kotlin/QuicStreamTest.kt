...
private const val quicDownstreamType = "type.googleapis.com/envoy.extensions.transport_sockets.quic.v3.QuicDownstreamTransport"
private const val quicUpstreamType = "type.googleapis.com/envoy.extensions.transport_sockets.quic.v3.QuicUpstreamTransport"
...
class QuicStreamTest {
  ...
  @Test
  fun `basic test of QUIC request and response`() {
