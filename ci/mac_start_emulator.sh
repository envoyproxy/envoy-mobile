...
echo "y" | $ANDROID_HOME/tools/bin/sdkmanager --install 'system-images;android-31;google_apis;x86_64' --channel=3
echo "no" | $ANDROID_HOME/tools/bin/avdmanager create avd -n test_android_emulator -k 'system-images;android-31;google_apis;x86_64' --force
