...
public final class Http2TestHandler extends Http2ConnectionHandler implements Http2FrameListener {
  ...
  public static final class Builder
    ...
    protected Http2TestHandler build(Http2ConnectionDecoder decoder, Http2ConnectionEncoder encoder,
      ...
      Http2TestHandler handler =
          new Http2TestHandler(decoder, encoder, initialSettings, mReportingCollector, mServerUrl);
  ...
  @Override
  public void onPingRead(ChannelHandlerContext ctx, long unused) throws Http2Exception {}

  @Override
  public void onPingAckRead(ChannelHandlerContext ctx, long unused) throws Http2Exception {}
